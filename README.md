...
This repository contains code and results for analyzing EEG session correlations, detecting bad channels, and visualizing within-experiment similarity in EEG datasets.
...
- **Rest of the Folders**: Figures and images generated by the analysis:
  - **Comparing_matrix_similarity_among_within_experiment_sessions**: Heatmaps showing within-experiment correlation between sessions.
