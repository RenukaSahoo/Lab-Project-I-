...
- **Rest of the Folders**: Figures and images generated by the analysis:
  - **Comparing_matrix_similarity_among_within_experiment_sessions**: Heatmaps showing within-experiment correlation between sessions to evaluate how similar are the ingter-channel correlation matrices among sessions within a experiment.
